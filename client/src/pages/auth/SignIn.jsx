...
function GridArt() {
  return (
    <div className="absolute inset-0">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(34,197,94,0.15),transparent_40%)]"></div>
      ...
      <div className="absolute top-20 right-10 w-28 h-28 bg-emerald-400/20 rounded-full blur-3xl"></div>
    </div>
  );
}