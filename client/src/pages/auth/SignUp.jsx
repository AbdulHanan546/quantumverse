  ...
  return (
    <div className="min-h-dvh grid lg:grid-cols-2">
      ...
      <div className="flex items-center justify-center p-6">
        <div className="w-full max-w-md card rounded-2xl p-8">
          ...
          <div className="text-sm text-slate-400">
            ...
            <Link to="/signin" className="text-green-400 hover:text-green-300 underline underline-offset-4">
              Sign in
            </Link>
          </div>
        </div>
...
function GridArt() {
  return (
    <div className="absolute inset-0">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(34,197,94,0.15),transparent_40%)]"></div>
      ...
      <div className="absolute -bottom-16 right-10 w-40 h-40 bg-green-500/20 rounded-full blur-3xl"></div>
      <div className="absolute top-10 left-16 w-28 h-28 bg-emerald-400/20 rounded-full blur-3xl"></div>
    </div>
  );
}