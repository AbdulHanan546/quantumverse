export const interferenceTopic = [
  {
    ...
    props: {
      ...
      background: "/images/Interferrence/download.jfif"
    }
  },

  {
    ...
    props: {
      ...
      character: { name: "Thomas", image: "/images/Scientists/Thomas/thinkingthomas.png" },
      ...
      scenes: [
        {
          ...
          character: { name: "", image: "/images/Scientists/Thomas/happythomas.png" },
          background: "/images/Interferrence/interferrecestory.png",
          emotion: "happy",
          orientation: "bottom-right"
        },
        {
          dialogue: "Here, we'll see how waves can combine in surprising ways.",
          character: { name: "Ava", image: "/images/Scientists/Thomas/happythomas.png" },
          background: "/images/Interferrence/interferrecestory.png",
          emotion: "excited",
...

  {
    ...
    props: {
      ...
      illustration: "/images/Interferrence/wave.gif",
      text:
...

  {
    ...
    props: {
      ...
      left: {
        label: "Single Wave",
        image: "/images/interferrence/singlewave.png",
        description: "Just one wave traveling."
      },
      right: {
        label: "Interfering Waves",
        image: "/images/interferrence/interferringwaves.png",
...

  {
    ...
    props: {
      ...
      gif: "/images/interferrence/wave.gif",
